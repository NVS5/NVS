...
// ترويسات CORS للسماح بالطلبات من أي مصدر (المتصفح و الـ NodeMCU)
const corsHeaders = {
...
export default {
  async fetch(request, env, ctx) {
    // 1. معالجة طلبات Preflight (OPTIONS)
    ...
    try {
      ...
      // 4. إرسال البيانات فقط (Data-Only Payload) لمنع التكرار وتمكين الـ Service Worker من العرض
