...
// معالجة واستقبال الإشعار في الخلفية (مرة واحدة فقط وبدون تكرار)
messaging.onBackgroundMessage((payload) => {
  ...
  const notificationOptions = {
    ...
    icon: '/NVS/logo.png',
    badge: '/NVS/logo.png',
    vibrate: [300, 100, 300, 100, 300], // نمط اهتزاز تنبيهي قوي
    requireInteraction: true, // يضمن بقاء الإشعار بارزاً على الشاشة
    renotify: true,
    tag: 'nova-smart-alert', // يمنع تراكم الإشعارات المتشابهة
    data: {
      url: targetUrl
    }
  };
