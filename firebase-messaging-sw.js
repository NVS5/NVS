...
//  توليد Access Token للـ Service Account
//  FIREBASE_CLIENT_EMAIL
//env.FIREBASE_PRIVATE_KEY);

// Cloudflare Worker - FCM v1 Notification Sender (Data Only)

const FIREBASE_PROJECT_ID = "smarthome-ad84f";
const DATABASE_URL = "https://smarthome-ad84f-default-rtdb.firebaseio.com";

// ترويسات CORS للسماح بالطلبات من أي مصدر (بما فيها المتصفح والـ NodeMCU)
const corsHeaders = {
...
export default {
  async fetch(request, env, ctx) {
    // 1. معالجة طلبات Preflight (OPTIONS) الخاص بالمتصفحات
    ...
    try {
      ...
      // 4. إرسال الإشعار لجميع التوكنات (استخدام data فقط لمنع الإشعار المزدوج)
